    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className={`text-sm font-medium px-2 py-1 rounded ${
                feedback.confidenceLevel === 'High' ? 'bg-green-100 text-green-800' :
                feedback.confidenceLevel === 'Medium' ? 'bg-yellow-100 text-yellow-800' :
      ...
      <div className="space-y-4">
        ...
        <section className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <p className="text-gray-800">{feedback.priorityFix}</p>
        </section>
        ...
        <section className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-gray-800">{feedback.drillSuggestion}</p>
        </section>
      </div>
